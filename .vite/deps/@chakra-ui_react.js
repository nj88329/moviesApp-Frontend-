import {
  _defineProperty
} from "./chunk-W34SRUNM.js";
import {
  _inheritsLoose,
  _objectWithoutPropertiesLoose
} from "./chunk-4DPIFTWX.js";
import {
  require_react_dom
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react53.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react53.useCallback)(() => {
    var _a2;
...
function useShortcut(props = {}) {
  ...
  const [keys, setKeys] = (0, import_react55.useState)([]);
  ...
  (0, import_react55.useEffect)(() => flush, []);
...
var useSafeLayoutEffect3 = isBrowser ? import_react56.useLayoutEffect : import_react56.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react57 = __toESM(require_react(), 1);
function useCallbackRef3(fn2, deps = []) {
  const ref = (0, import_react57.useRef)(fn2);
  useSafeLayoutEffect3(() => {
    ref.current = fn2;
  });
  return (0, import_react57.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react59.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react64.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react65.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react67.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react68.useState)(null);
  const ref = (0, import_react68.useCallback)(
    (node2) => {
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react69.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react69.useCallback)(
    (next) => {
...
function useDisclosure(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react70.useState)(props.defaultIsOpen || false);
  ...
  const onToggle = (0, import_react70.useCallback)(() => {
...
function useEventListenerMap() {
  ...
  const add = (0, import_react71.useCallback)((el, type, listener, options) => {
...
var useUpdateEffect2 = (effect5, deps) => {
  const renderCycleRef = (0, import_react72.useRef)(false);
  const effectCycleRef = (0, import_react72.useRef)(false);
...
function useFocusOnShow(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react73.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react73.useRef)(visible);
  useSafeLayoutEffect3(() => {
  ...
  const onFocus3 = (0, import_react73.useCallback)(() => {
...
function useForceUpdate() {
  const unloadingRef = (0, import_react74.useRef)(false);
  const [count, setCount] = (0, import_react74.useState)(0);
  useUnmountEffect(() => {
...
function useBoolean(initialState2 = false) {
  const [value, setValue] = (0, import_react76.useState)(initialState2);
  const callbacks = (0, import_react76.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react77.useState)(false);
  const [valueState, setValueState] = (0, import_react77.useState)(value);
  (0, import_react77.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react77.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react79.useState)(null);
  const rafId = (0, import_react79.useRef)();
  useSafeLayoutEffect3(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react80.cloneElement)(child, theming) : (0, import_react80.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react81.useMemo)(
    () => shouldWrapChildren ? import_react81.Children.map(children, (child, index) => (0, import_jsx_runtime69.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react82.useMemo)(
    () => getDividerStyles({ spacing, direction }),
    [spacing, direction]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react82.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react82.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime72.jsxs)(import_react82.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime78.jsx)(import_jsx_runtime78.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime78.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime78.jsx)(import_react83.Fragment, { children: chunk.text }, index);
  }) });
}
...
function useShortcut2(props = {}) {
  const { timeout = 300, preventDefault = () => true } = props;
  const [keys, setKeys] = (0, import_react87.useState)([]);
...
function useEventListeners() {
  ...
  const currentListeners = listeners.current;
  const add = (0, import_react88.useCallback)((el, type, listener, options) => {
...
function useAnimationState2(props) {
  ...
  const [once, setOnce] = (0, import_react94.useState)(false);
...
var ModalTransition = (0, import_react99.forwardRef)(
  (props, ref) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react111.cloneElement)(child, { __css: styles })
  );
...
function usePopover(props = {}) {
  ...
  const openTimeout = (0, import_react113.useRef)();
  const closeTimeout = (0, import_react113.useRef)();
...
function PopoverAnchor(props) {
  ...
  return (0, import_react114.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const focus2 = (0, import_react115.useCallback)(() => {
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react117.useId)()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = (0, import_react117.useState)(false);
  const [isFocused, setFocused] = (0, import_react117.useState)(false);
  const [isHovered, setHovering] = (0, import_react117.useState)(false);
  const [isActive, setActive] = (0, import_react117.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react117.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react117.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react118.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime133.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react118.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react119.useRef)(true);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react122.useRef)(null);
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react123.useState)([]);
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react130.useState)(defaultIndex != null ? defaultIndex : 0);
